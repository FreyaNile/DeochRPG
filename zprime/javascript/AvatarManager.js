...
export const AvatarManager = {
    ...
    cleanup() {
        ...
        if (this.elements.container) this.elements.container.style.cursor = '';
    ...
    async save() {
        ...
        // Current image center relative to container center
        const imgCenterX = (containerSize / 2) + this.state.posX;
        const imgCenterY = (containerSize / 2) + this.state.posY;
